            ...
            <div class="row">
                ...
                <div class="col-xl-9">
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.profile.update', $profileData->id) }}" method="POST"
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="lastName">Usename</label>
                                            <input type="text" value="{{ $profileData->username }}" class="form-control"
                                                name="username">
                                        </div>
                                    </div>
                                </div>
