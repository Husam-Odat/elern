                ...
                <div class="card-body">
                    <form action="{{ route('admin.classes.update', $classes->id) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                <div class="mb-5">
                                    <label class="text-dark font-weight-medium">Teacher</label>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                        ...
                                        <select class="form-control" name="user_id" id="">
                                            ...
                                            @foreach ($users as $user)
                                                <option {{ $classes->user_id == $user->id ? 'selected' : '' }}
                            ...
                            <div class="col-xl-12">
                                <div class="mb-5">
                                    <label class="text-dark font-weight-medium">class Location</label>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                            ...
                            <div class="col-xl-12">
                                <div class="mb-5">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <textarea rows="5" class="form-control" name="desc">{{ $classes->desc }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
