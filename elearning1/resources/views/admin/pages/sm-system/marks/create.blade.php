                ...
                <div class="card-body">
                    <form action="{{ route('admin.salaries.store') }}" method="POST">
                        ...
                        <div class="row">
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-control" name="student_id" id="">
                                            <option value="">Choose an Students</option>
                            ...
                            <div class="col-xl-6">
                                <div class="mb-5">
                                    <label class="text-dark font-weight-medium">exams</label>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text mdi mdi-account-card-details"
                                                id="basic-addon1"></span>
                                        </div>
                                        <select class="form-control" name="exam_id" id="">
