                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-control" name="freelancer">
                                            ...
                                            @foreach ($users as $user)
                                                <option {{ $project->seller_id == $user->id ? 'selected' : '' }}
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-control" name="duration">
                                            ...
                                            <option {{ $project->deadline == '3' ? 'selected' : '' }} value="3">3 days
                                            </option>
                                            <option {{ $project->deadline == '5' ? 'selected' : '' }} value="5">5 days
                                            </option>
                                            <option {{ $project->deadline == '7' ? 'selected' : '' }} value="7">1 week
                                            </option>
                                            <option {{ $project->deadline == '14' ? 'selected' : '' }} value="14">2
                                                weeks</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-control" name="status">
                                            ...
                                            <option {{ $project->status == 'active' ? 'selected' : '' }} value="active">
                                                active</option>
                                            <option {{ $project->status == 'inactive' ? 'selected' : '' }}
